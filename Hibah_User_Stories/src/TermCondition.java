...
public class TermCondition {
    ...
    public static void main(String[] args, Map<String, String> authenticatedUserMap) throws ClassNotFoundException, SQLException {
        ...
        // create a new file object and check if file exists
        // create file reader to actually read text file, using buffered reader to read line alltogetehr
        ...
        try {
           ...
           // now if you are an admin (user roles from db) only then are you given the option to edit terms and conditions
            // if file can't be read - exception handling since i encountered a problem earlier 
